...
|
*/
//$config['auth_override_class_method']['sam']['login_get'] = 'none';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
|
*/
$config['rest_keys_table'] = 'ecc_keys_key';
...
|
*/
$config['rest_key_name'] = 'x-sam-api-key';
...
|
*/
$config['rest_logs_table'] = 'ecc_apiLogs_al';
